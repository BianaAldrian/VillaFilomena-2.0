...
public class BookingInfo_Model {
    String id, guest_email, checkIn_date, checkIn_time, checkOut_date, checkOut_time, adult_qty, kid_qty, room_id, cottage_id, total_payment, payment_status, GCash_number, reference_num, receipt_url, bookings_status;

    public BookingInfo_Model(String id, String guest_email, String checkIn_date, String checkIn_time, String checkOut_date, String checkOut_time, String adult_qty, String kid_qty, String room_id, String cottage_id, String total_payment, String payment_status, String GCash_number, String reference_num, String receipt_url, String bookings_status) {
        this.id = id;
