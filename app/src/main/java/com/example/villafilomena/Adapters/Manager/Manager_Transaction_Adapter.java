...
public class Manager_Transaction_Adapter extends RecyclerView.Adapter<Manager_Transaction_Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Manager_Transaction_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.transaction_history_list, parent, false);
        return new Manager_Transaction_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Manager_Transaction_Adapter.ViewHolder holder, int position) {
