...
public class Guest_MonthYearAdapter extends RecyclerView.Adapter<Guest_MonthYearAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Guest_MonthYearAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Guest_MonthYearAdapter.ViewHolder holder, int position) {
