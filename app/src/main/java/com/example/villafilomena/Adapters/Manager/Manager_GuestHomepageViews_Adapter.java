...
public class Manager_GuestHomepageViews_Adapter extends RecyclerView.Adapter<Manager_GuestHomepageViews_Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Manager_GuestHomepageViews_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.manager_banner_image_list, parent, false);
        return new Manager_GuestHomepageViews_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Manager_GuestHomepageViews_Adapter.ViewHolder holder, int position) {
