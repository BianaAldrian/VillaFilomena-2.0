...
public class Guest_bookingDetails_Adapter extends RecyclerView.Adapter<Guest_bookingDetails_Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Guest_bookingDetails_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.guest_bookings_list, parent, false);
        return new Guest_bookingDetails_Adapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull Guest_bookingDetails_Adapter.ViewHolder holder, int position) {
