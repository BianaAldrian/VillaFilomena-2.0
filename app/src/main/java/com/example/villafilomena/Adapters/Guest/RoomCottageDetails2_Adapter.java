...
public class RoomCottageDetails2_Adapter extends RecyclerView.Adapter<RoomCottageDetails2_Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public RoomCottageDetails2_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.selected_room_cottage_details_list, parent, false);
        return new RoomCottageDetails2_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RoomCottageDetails2_Adapter.ViewHolder holder, int position) {
