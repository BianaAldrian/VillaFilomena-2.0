...
public class FrontDesk_Arrival_Departure_Adapter extends RecyclerView.Adapter<FrontDesk_Arrival_Departure_Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FrontDesk_Arrival_Departure_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.frontdesk_arrival_departure_list, parent, false);
        return new FrontDesk_Arrival_Departure_Adapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull FrontDesk_Arrival_Departure_Adapter.ViewHolder holder, int position) {
