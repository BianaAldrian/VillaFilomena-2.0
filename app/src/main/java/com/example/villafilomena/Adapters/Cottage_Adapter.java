...
public class Cottage_Adapter extends RecyclerView.Adapter<Cottage_Adapter.ViewHolder> {
    ...
    public Cottage_Adapter( Context context, ArrayList<RoomCottageDetails_Model> detailsHolder) {
    ...
    @NonNull
    @Override
    public Cottage_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Cottage_Adapter.ViewHolder holder, int position) {
